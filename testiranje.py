...
def main():
    ...
    ball = make_ball(0,random.randrange(BALL_SIZE[0], SCREEN_WIDTH - BALL_SIZE[0]),random.randrange(100, SCREEN_HEIGHT - BALL_SIZE[0]), 1 )
    ...
    while not done:
        ...
        for ball in ball_list:
            ...
            if ball.new is not True and ball.num <= 3:
                ...
                if ball.y > SCREEN_HEIGHT - BALL_SIZE[ball.num] or ball.y < 75*(ball.num + 1):
                    ball.change_y *= -1
                if ball.x > SCREEN_WIDTH - BALL_SIZE[ball.num] or ball.x < BALL_SIZE[ball.num]:
                    ball.change_x *= -1
        ...
        for ball in ball_list:
            if ball.num <= 3:
                pygame.draw.circle(screen, WHITE, [ball.x, ball.y], BALL_SIZE[ball.num])
